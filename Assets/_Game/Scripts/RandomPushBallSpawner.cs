...
public class RandomPushBallSpawner : MonoBehaviour
{
    public GameObject randomPushBallPrefab;


    public int RandomPushPerField = 3;
    ...
    List<GameObject> RandomBalls = new List<GameObject>();
    ...
    private void Update()
    {
        PopulateOnUpdate(randomPushBallPrefab, RandomPushPerField, RandomBalls);
