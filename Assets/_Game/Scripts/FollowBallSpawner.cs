...
public class FollowBallSpawner : MonoBehaviour
{
    public GameObject followBallPrefab;


    public int followPerField = 1;
    ...
    List<GameObject> followBalls = new List<GameObject>();
    ...
    private void Update()
    {
        PopulateOnUpdate(followBallPrefab, followPerField, followBalls);
